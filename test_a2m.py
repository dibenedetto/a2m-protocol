...
including one written in another language -- use a2m_conformance.py, which
...
def test_a2m_stdio() -> None:
	...
	memory = connect_stdio([sys.executable, "a2m.py", "remote-memory"], on_stderr=lambda line: print("    [server]", line))
	try:
